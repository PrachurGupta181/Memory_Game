...
public class MainActivity extends AppCompatActivity {
    ...
    private void calculate() {
        ...
        if (firstCard == secondCard) {
            ...
            //add players to the correct player
            if (turn == 1){
                playerPoints++;
            ...
            iv_11.setImageResource(R.drawable.quemark);
            iv_12.setImageResource(R.drawable.quemark);
            iv_13.setImageResource(R.drawable.quemark);
            iv_14.setImageResource(R.drawable.quemark);
            iv_21.setImageResource(R.drawable.quemark);
            iv_22.setImageResource(R.drawable.quemark);
            iv_23.setImageResource(R.drawable.quemark);
            iv_24.setImageResource(R.drawable.quemark);
            iv_31.setImageResource(R.drawable.quemark);
            iv_32.setImageResource(R.drawable.quemark);
            iv_33.setImageResource(R.drawable.quemark);
            iv_34.setImageResource(R.drawable.quemark);
